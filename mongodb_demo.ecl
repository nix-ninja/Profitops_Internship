//THIS FILE DISPLAYS THE FUNCTIONS THAT ARE SUPPORTED BY THE Mongodb PLLUGIN
//THE DATA USED HERE IS THE SAMPLE DATA PROVIDED BY MONGO DB AND CAN BE EASILY IMPORTED IN A CLUSTER
Import MongoDB;
